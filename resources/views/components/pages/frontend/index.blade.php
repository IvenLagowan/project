<x-Layouts.visitor-layout>
        ...
        <div class="grid py-20 mx-auto md:grid-cols-2 max-w-7xl">
            <div class="pl-10 mb-8 space-y-10 text-white text-balance ">
                ...
                <p class="w-3/4 font-inter">
                    Informasi terbaru dan terlengkap tentang berbagai acara menarik di tempat wisata Papua Tengah. Temukan
                    ...
                    Sukarame
                    Mari jadikan momen liburan Anda di Papua Tengah semakin berkesan dengan mengikuti berbagai acara seru
                    yang tersedia.
                </p>
                <div class="mt-6">
                    <a href="{{ route('events') }}"
    ...
    <section class="relative px-3 md:px-0 mt-29">
        <div class="mb-8 text-4xl font-extrabold text-center">
            <h1 class="font-inter">Informasi Tentang Wisata</h1>
        </div>
