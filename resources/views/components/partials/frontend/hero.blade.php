...
<section class="pt-10 bg-white">
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-inter font-light text-gray-700 lg:mb-8 md:text-lg lg:text-xl">Provinsi Papua Tengah,
                terletak di provinsi Papua Tengah, telah diakui sebagai salah satu wisata Indonesia. Julukan ini
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <iframe loading="lazy" title="DESA WISATA SUKARAME KAB. BANDUNG" class="w-full h-full rounded-lg"
                src="https://www.youtube.com/embed/FXUtDpQKbSY?si=j-nMeAfOeSD9JpoU" frameborder="0"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        gsap.to(myElement, {
            text: "WISATA <br>TOUR TRAVEL PROVINSI PAPUA TENGAH",
            duration: 3,
            repeat: 0,
            ease: "none",
        });
