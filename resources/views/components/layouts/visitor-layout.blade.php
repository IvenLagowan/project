...
<head>
    ...
    <title>{{ $title ?? '' }} Provinsi Papua Tengah</title>
</head>
    ...
    <footer class="w-full mt-20 text-gray-700 bg-gray-100 body-font">
        <div class="flex flex-col items-center px-5 py-5 md:flex-row ">
            <div class="mx-auto text-center lg:w-1/2 md:mx-0 ">
                ...
                <p class="mt-2 text-sm text-gray-500">Perisai bersudut lima dengan garis warna merah dan putih, serta tulisan "Papua Tengah". </p>
                <div class="mt-4">
                    <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                        ...
                        <a href="https://youtube.com/@ivenlagowan.official?feature=shared"
